...
**Pendente** (tem mockup, falta implementar): grade **semanal** de escala, **linha do tempo operacional**, **PVPS/lotes/validade** + **recebimento de nota**, **Pessoas & Ponto** (gerencial), **Fornecedores**, **Mural & Clima**, **Bot de Suporte**, **Wizard por ramo** (versão rica), **Log de Auditoria**, **upload de mídia**, e as frentes **Vendas & Comandas + Financeiro**. Apps satélites **KDS** e **Ponto** (independentes, WebSocket).
