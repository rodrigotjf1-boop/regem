# Regem Edge — APLICAR atualização no PC da LOJA (blue-green + backup + rollback).
#
# Fluxo seguro:
...
# ---- lê o .env.local (APP_VERSION, CLOUD_API, EDGE_DATABASE_URL) ----
...
function Svc($acao, $nome) { nssm $acao $nome 2>$null | Out-Null }
